...
class SuratApp(QMainWindow):
    def __init__(self):
        ...
        ModernMessageBox.show_success(self, "Welcome", "✅ Selamat datang di Aplikasi Persuratan SLBN Tanah Grogot ✅\n\nBy: Fahmi Firdausi")
    ...
    def load_data(self):
        try:
            ...
            ModernMessageBox.show_success(self, "Update", "✅ Data berhasil dimuat! ✅")
